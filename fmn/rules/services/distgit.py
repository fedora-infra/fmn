...
from ...backends import PagureSyncProxy
...
class DistGitService:
    ...
    def get_owned(self, artifact_type, name, user_or_group):
        ...
        projects = list(self.proxy.get_paginated(endpoint, params=params, payload_field="projects"))
